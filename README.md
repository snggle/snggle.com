...
Releases static page to IPFS

### Overview

1. The [base docker image](ghcr.io/kiracore/docker/base-image:v0.12.2) with preinstalled chromedriver is launched
2. The [ipfs-api](https://github.com/KiraCore/tools/tree/main/ipfs-api) CLI tool communicates with pinata to upload the root folder
...
* If you are satisfied with the release merge the PR and website will get automagically deployed